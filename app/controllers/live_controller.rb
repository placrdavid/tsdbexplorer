...
class LiveController < ApplicationController
   ...
   def london_performance_json
      ...
      crs_tiplocs.each do |crs, tiploc_code_csv|
         ...
         avg_secs_lateness = Performance.get_station_performance(tiploc_code_csv, 'departures')

         station_hash = {:lat => 51.517989, :lon => -0.081426, :crs => crs, :name => "London Liverpool Street", :avg_secs_late => avg_secs_lateness, :sample_size => 12}
