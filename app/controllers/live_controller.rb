...
# order by planned_departure       
      ...
      @schedule.each do |schedule|
         ...
         # could cause problems if now is after midnight
      ...
      # check if we have a matching station update, if so, add it..
...
matching_station_update = nil
      ...
      station_updates_matches.each do |station_updates_match|
        ...
        timetable_hash = {}
         ...
         timetable_hash['platform'] = schedule[:obj].tiploc_code
         ...
         timetable_hash['service_name'] = schedule[:service_code]         
         timetable_hash['operator_ref'] = schedule[:atoc_code]
