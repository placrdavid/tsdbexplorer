...
ActiveRecord::Schema.define(:version => 20140211121111) do
  ...
  add_index "basic_schedules", ["runs_to"], :name => "index_basic_schedules_on_runs_to"
  ...
  create_table "tiplocs", :force => true do |t|
    ...
    t.string  "tps_description", :limit => 50
